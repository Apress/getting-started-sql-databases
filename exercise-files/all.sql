...
/*	3.24: Extra Spaces
	================================================
	ANSI Standard: Trailing Spaces Ignored

	MySQL / MariaDB, MSSQL: Trailing Spaces Ignored
	PostgreSQL, SQLite, Oracle: Trailing Spaces Significant
	================================================ */
...
/*	3.30: Dates with Extra Spaces
	================================================
	Oracle: date '  1989-11-09  '
	SQLite: string match, so won’t work
	================================================ */
...
/*	3.32: Date Variations
	...
	Oracle won’t accept:
		'November 9, 1989'
		'9/11/1989'
	SQLite won’t accept any variations
	================================================ */
...
/*	3.35: Date Calculation
	================================================
	--	PostreSQL, Oracle, MySQL/MariaDB
		SELECT * FROM customers
...
/*	3.51: Case Sensitivity
	================================================
	MSSQL, MySQL / MariaDB: Case Insensitive
	PostgreSQL, Oracle, SQLite: Case Sensitive
	================================================ */
...
/*	4.22: Paged Results
	================================================
	PostgreSQL, MSSQL, Oracle
		ORDER BY dob OFFSET … ROWS FETCH FIRST … ROWS ONLY;

	PostgreSQL, MySQL / MariaDB, SQLite:
		ORDER BY dob LIMIT … OFFSET …;
	================================================ */
...
/*	4.25: Arbitrary String Sort
	...
	--	MSSQL:							CHARINDEX(value, 'values')
		...
		FROM sorting
		ORDER BY
		CHARINDEX(numbername, 'One,Two,Three,Four,Five,Six,Seven,Eight,Nine');
	================================================ */
...
/*	5.16: Integer Division
	================================================
	PostgreSQL, MSSQL, SQLite :	200/7 = 28
	MySQL/MariaDB, Oracle :		200/7 = 28.571428…
	================================================ */
...
/*	5.24: Age Calculations
	================================================
	PostgreSQL: SELECT id, givenname, familyname, dob, age(dob) FROM customers;
	--	PostgreSQL
		SELECT
...
/*	6.12: VIEW with JOIN
	================================================
	--	Not Oracle:DROP VIEW IF EXISTS pricelist;
		CREATE VIEW pricelist AS
		SELECT
			p.id,
			p.title,
...
/*	7.26: Redundant Groups
	...
	--	PostgreSQL, Oracle
		SELECT
			to_char(ordered,'FMDay') AS dayname,
			sum(total) AS total
		FROM sales
