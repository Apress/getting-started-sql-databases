/**	Microsoft SQL Quirks
	================================================
	Semicolons may be omitted, but shouldn’t
		https://docs.microsoft.com/en-us/sql/t-sql/language-elements/transact-sql-syntax-conventions-transact-sql#transact-sql-syntax-conventions-transact-sql

	Concatenation uses +
		This can create issues concatatenating with numbers

	CREATE VIEW must be the only statement in its batch.
		This requires GO around the statement.

	To INSERT into an identity column:
...
/**	Chapter 1: Sampler
	================================================
	This introduces the SELECT statement with a number
...
/*	1.02: Specific Columns
	================================================
	You can select individual columns in any order.
	================================================ */
...
/*	1.04: Aliases
	================================================
	The calculated column should be given an alias.
	================================================ */
...
/*	1.05: Comments
	================================================
	Use a comment to explain something not obvious.
	The line comment begins with --
...
/*	1.06: Filtering Rows
	================================================
	The WHERE clause filters rows in a tabler.
	================================================ */
...
/*	1.08: SELECT DISTINCT
	================================================
	SELECT DISTINCT lists groups.
	================================================ */

	--	You might want a list of email addresses:
		SELECT email FROM customers;

	--	However, you probably don’t want a list of states:
		SELECT state FROM customers;

	--	You may, however want a list of different states:
		SELECT DISTINCT state FROM customers;

/*	1.09: DISTINCT Multiple Columns
	================================================
	SELECT DISTINCT works on the whole list.
	An individual column is not necessarily distinct;
	however, the combination is.
	================================================ */

	SELECT DISTINCT state,town FROM customers;

/*  1.10: SQL Sampler Summary
	================================================
...
/**	Chapter 3: WHERE clause
	================================================
	The WHERE clause filters the table.
	================================================ */

/*	3.01: Shorter Customers
	================================================
	A simple comparison of numbers.
	================================================ */
...
/*	3.02: Not Shorter Customers
	================================================
	You can reverse the assertion with NOT.
	There is often an alternative expression.
	================================================ */
...
/*	3.04: Unrelated Assertions
	================================================
	The assertion doesn’t necessarily need to involve
	actual column data.
	================================================ */
...
/*	3.05: All and Nothing
	================================================
	Some assertions end up selecting all or nothing.
	================================================ */
...
/*	3.07: Compare with NULLs
	================================================
	You really want NULLs to be ignored with comparisons.
	================================================ */
...
/*	3.08: Finding NULLs
	================================================
	To select NULLs, you need IS [NOT] NULL.
	================================================ */
...
/*	3.09: All Heights
	================================================
	Since NULLs fail comparisons, combining the previous
	results return NOT NULL matches.
	================================================ */
...
/*	3.10: Discrete Years
	================================================
	Sometimes numbers are discrete.
	================================================ */
...
/*	3.11: Continuous Heights
	================================================
	Sometimes numbers are (relatively) continuous.
	================================================ */
...
/*	3.13: Non Existant Values
	================================================
	Selecting for a non existant value is not an error.
	================================================ */
...
/*	3.14: Unmatched Data Type
	================================================
	Comparisons must involved compatible data types.
	This one will fail.
	================================================ */
...
/*	3.35: Date Calculation
	...
	SELECT * FROM customers WHERE dob<dateadd(year,-40,current_timestamp);
...
/*	3.57: Regular Expressions
	...
	SELECT *
	FROM customers
	WHERE lower(familyname) LIKE '[a-k][^hy]%';
...
/*	5.22: Current Date & Time
	...
	SELECT current_timestamp;	--	aka getdate()
...
/*	5.24: Age Calculations
	...
	SELECT
		...
		datediff(year,dob,current_timestamp) AS age --	but not quite!
	FROM customers;
...
GO
	...
	SELECT
		id, givenname, familyname, dob,
		dbo.age(dob,current_timestamp) AS age
	FROM customers;
...
/*	5.33: Trim
	...
	SELECT trim(' abcdefghijklmnop ');	--	MSSQL>=2017
...
/*	6.23: JOIN on Birthday
	...
	FROM
		...
		JOIN customers AS c
			ON format(ad.borndate,'MM-dd')= format(c.dob,'MM-dd');
...
/*	7.18: Shorter than Average
	...
	SELECT * FROM customers
	WHERE height<(SELECT avg(height)-stdev(height) FROM customers);
...
/*	7.26: Redundant Groups
	...
	SELECT
		datename(weekday,ordered) AS dayname,
		sum(total) AS total
	FROM sales
	GROUP BY datename(weekday,ordered), datepart(weekday,ordered)
	ORDER BY datepart(weekday,ordered);

/*	7.27: Using Dummy Aggregate
	================================================
	Standard: c.givenname||' '||c.familyname
	================================================ */
